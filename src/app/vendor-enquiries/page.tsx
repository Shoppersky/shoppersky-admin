...
//     queryId: string,
//     message: string,
//     messageType: "response" | "followup" = "response"
//   ) => {
//     try {
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden lg:table-cell">Unread</TableHead>
                  ...
                  {filteredQueries.map((query) => (
                    ...
                    >
                      ...
                      <TableCell className="max-w-[220px]">
                        <div className="truncate">{query.vendorName}</div>
                        {query.vendorEmail ? (
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="capitalize text-xs sm:text-sm">{query.priority}</span>
                        </div>
                      </TableCell>
                      ...
                      <TableCell className="hidden lg:table-cell">{query.unreadCount}</TableCell>

                      <TableCell className="hidden lg:table-cell">{query.assignedTo || "—"}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
