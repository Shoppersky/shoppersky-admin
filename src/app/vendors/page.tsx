...
// //             isEmailVerified: vendor_login.verified_email || true,
// //             avatar:
...
// //                   </td>
// //                   <td>
// //                     <Badge variant={vendor.isActive ? "destructive" : "success"}>
...
// //                               </label>
// //                               <p className="text-sm text-slate-900 dark:text-slate-100 mt-1">
// //                                 {selectedVendor.industryName || "N/A"}
// //                               </p>
// //                             </div>
// //                           </CardContent>
// //                         </Card>
...
// //                               </label>
// //                               <p className="text-sm text-slate-900 dark:text-slate-100 mt-1">
// //                                 {selectedVendor.paymentPreference || "N/A"}
// //                               </p>
// //                             </div>
// //                           </CardContent>
// //                         </Card>
...
// //                               </label>
// //                               <p className="text-lg font-semibold text-slate-900 dark:text-slate-100 mt-1">
// //                                 {selectedVendor.abnDetails.entityName || "N/A"}
// //                               </p>
// //                             </div>
// //                             <div>
// //                               <label className="text-sm font-medium text-slate-600 dark:text-slate-400">
...
// //                               </label>
// //                               <p className="text-lg text-slate-900 dark:text-slate-100 mt-1">
// //                                 {selectedVendor.abnDetails.type || "N/A"}
// //                               </p>
// //                             </div>
// //                           </div>
// //                           <div className="space-y-4">
...
// //                               </label>
// //                               <p className="text-lg text-slate-900 dark:text-slate-100 mt-1">
// //                                 {selectedVendor.abnDetails.businessLocation || "N/A"}
// //                               </p>
// //                             </div>
// //                           </div>
// //                         </CardContent>
...
// //                               onClick={() =>
// //                                 handleRestoreVendor(selectedVendor)
// //                               }
// //                             >
...
//             status,
//             isActive: vendor_login.is_active,
//             isEmailVerified: vendor_login.verified_email ? true : false,
...
//                 </Avatar>
//                 <div className="flex-1 min-w-0">
//                   <h2 className="text-base sm:text-lg lg:text-2xl font-bold text-slate-800 dark:text-slate-100 truncate">
//                     {selectedVendor.storeName || selectedVendor.email}
//                   </h2>
//                   <p className="text-xs sm:text-sm lg:text-base text-slate-600 dark:text-slate-400 mt-1 truncate">
//                     {selectedVendor.industryName || "Registered Vendor"}
