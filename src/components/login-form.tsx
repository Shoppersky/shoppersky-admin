...
import { useRouter } from "next/navigation"
import { useState, useEffect } from "react"
import { Eye, EyeOff, Mail, Lock, Sparkles, ArrowRight, Shield, Zap, Users } from "lucide-react"
import axiosInstance from "@/lib/axiosInstance"
import useStore from "@/lib/Zustand"
import { toast } from "sonner"
import Link from "next/link"
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 min-h-screen w-full relative z-10">
        ...
        {/* Right Side - Login Form */}
        <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-12 xl:p-16 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={(e) => setEmail(e.target.value)}
                    required
                    className="h-12 sm:h-14 pl-10 sm:pl-12 bg-white/80 dark:bg-slate-800/80 border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                  />
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={(e) => setPassword(e.target.value)}
                    required
                    className="h-12 sm:h-14 pl-10 sm:pl-12 pr-10 sm:pr-12 bg-white/80 dark:bg-slate-800/80 border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                  />
              ...
              <Button
                type="submit"
                disabled={isLoading || !email || !password || !emailValid}
                className="w-full h-12 sm:h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base font-semibold"
              >
                {isLoading ? (
                  <div className="flex items-center gap-2">
